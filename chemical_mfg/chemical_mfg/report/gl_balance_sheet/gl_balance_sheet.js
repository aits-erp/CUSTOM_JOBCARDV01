...
frappe.query_reports["GL Balance Sheet"] = $.extend({}, erpnext.financial_statements);

erpnext.utils.add_dimensions("GL Balance Sheet", 10);

frappe.query_reports["GL Balance Sheet"]["filters"].push(
	{
